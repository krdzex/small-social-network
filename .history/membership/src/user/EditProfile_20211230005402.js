...
export default function EditProfile({ match }) {
    ...
    const clickSubmit = () => {
        const userData = {
            name: values.name && userData.append("name", values.name) || undefined,
        ...
        <div>
            <Card className={classes.card}>
                <CardContent>
                    ...
                    <input accept="image/*" type="file" onChange={handleChange("photo")} className={classes.input} style={{display: "none"}} id="icon-button-file" />
