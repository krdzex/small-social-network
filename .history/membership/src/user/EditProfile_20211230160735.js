...
export default function EditProfile({ match }) {
    ...
    const clickSubmit = () => {
        ...
        values.name && userData.append("email", values.email)
        values.name && userData.append("password", values.password)
        values.name && userData.append("about", values.about)
        values.name && userData.append("photo", values.photo)
